...
public class Sign_up_step2_SceneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        txtAccount.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
        ...
        txtConfirmPassword.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if (!newValue) {
